...
`R` є безкоштовним програмним забезпеченням, що розповсюджується за умовами [GNU General Public License](https://www.r-project.org/COPYING). Код, написаний на `R` компілюється та запускається на різних платформах: UNIX, Windows, MacOS.
...
![Google Chrome Dowload Button](images/chapter1/chrome_download_button.png)
...
![R gui](images/chapter1/r_gui_4.png)
...
![R Console](images/chapter1/r_gui_5.png)
...
##  [7] "02-references.Rmd"     "book.bib"              "css"                  
## [10] "favicon.ico"           "images"                "inc"                  
## [13] "index.md"              "index.Rmd"             "index.utf8.md"        
## [16] "packages.bib"          "preamble.tex"          "r-intro.rds"          
## [19] "README.md"             "render_commands"       "renderd60306a37f1.rds"
## [22] "RIntro.Rproj"          "tmp.RData"
```
...
2. Знаходимо на сторінці кнопку для завантаження програми `RStudio Desktop` версії `Open Source` та натискаємо **DOWNLOAD RSTUDIO DESKTOP**: ![RStudio Desktop](images/chapter1/rstudio_1.png)

3. Далі обираємо завантаження безкоштовної версії `RStudio Desktop` з наданого переліку:
![Download RStudio](images/chapter1/rstudio_2.png)
...
![RStudio UI](images/chapter1/rstudio_3.png)

Для першої демонстрації роботи виконаємо у консолі 2 рядки коду:
![Test App](images/chapter1/rstudio_4.png)
...
![Create Project](images/chapter1/rstudio_6.png)

На наступному кроці обираємо `New Project`: ![New Project](images/chapter1/rstudio_7.png)
...
![First Project View](images/chapter1/rstudio_9.png)
...
```
##  [1] 1 4 5 5 3 1 4 2 5 1 2 3 4 3 5 2 2 5 4 4
```
...
![](01-chapter1_files/figure-epub3/unnamed-chunk-9-1.png)<!-- -->
...
![First Project View](images/chapter1/rstudio_10.png)
...
Після запуску `Anaconda Navigator` для початку потрібно створити нове середовище та налаштувати роботу `R`:  ![Anaconda](images/chapter1/anaconda_1.png)

Для початку потрібно перейти на вкладку `Environments` та натиснути `Create`:

![Anaconda1](images/chapter1/anaconda_2.png)

У вікні, що відкрилося потрібно відмітити [x] вставновлення інструментів для роботи з `R`:

![Anaconda2](images/chapter1/anaconda_3.png)

Після встановлення R-інструментів оптрібно переключитися на вкладку `Home` та робочий простір:
![Anaconda4](images/chapter1/anaconda_4.png)
...
![JN](images/chapter1/anaconda_6.png)
...
![Vs Code](images/chapter1/vs_code.png)
...
![Google Collab](images/chapter1/google_collab.png)
...
![Kaggle](images/chapter1/kaggle.png)
...
![Pack](images/chapter1/packages_1.png)

Після вибору `Install Packages...` відкриється вікно, де можна обрати як джерело інсталяції пакету так і сам пакет з переліку, вівши кілька перших букв його назви: ![Pack](images/chapter1/packages_2.png)
...
![Pack](images/chapter1/packages_3.png)
...
![Pack](images/chapter1/packages_4.png)
