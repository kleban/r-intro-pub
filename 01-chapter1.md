...
![(\#fig:unnamed-chunk-1)Завантаження R. Вибір ОС](images/chapter1/r_gui_1.png) 

У наступному вікні клікаємо на **install R for the first time**:


![(\#fig:unnamed-chunk-2)Завантаження R. Перша інсталяція](images/chapter1/r_gui_2.png) 

Далі обираємо **Download R 4.X.X for Windows**, де `4.X.X` версія `R`, яка може бути відмінною на момент вивчення курсу: 

![(\#fig:unnamed-chunk-3)Завантаження R. Завантаження версії для ОС](images/chapter1/r_gui_3.png) 
...
![(\#fig:unnamed-chunk-4)Завантаження R. Розділ "Завантаження" у Google Chrome](images/chapter1/chrome_download_button.png) 
...
![(\#fig:unnamed-chunk-5)Вигляд головного вікна RGui](images/chapter1/r_gui_4.png) 
...
![(\#fig:unnamed-chunk-6)Вигляд консолі для команд RGui](images/chapter1/r_gui_5.png) 
...
![(\#fig:unnamed-chunk-13)Вибір версії RStudio Desktop](images/chapter1/rstudio_1.png) 

3. Далі обираємо завантаження безкоштовної версії `RStudio Desktop` з наданого переліку:

![(\#fig:unnamed-chunk-14)Завантаження RStudio Desktop](images/chapter1/rstudio_2.png) 
...
![(\#fig:unnamed-chunk-15)Головне вікно RStudio Desktop](images/chapter1/rstudio_3.png) 

Для першої демонстрації роботи виконаємо у консолі 2 рядки коду:
![(\#fig:unnamed-chunk-16)Приклад написання коду в RStudio Desktop](images/chapter1/rstudio_4.png) 
...
![(\#fig:unnamed-chunk-17)RStudio Desktop. Новий проект](images/chapter1/rstudio_6.png) 

На наступному кроці обираємо `New Project`: 

![(\#fig:unnamed-chunk-18)RStudio Desktop. Новий проект. Тип проекту](images/chapter1/rstudio_7.png) 
...
![(\#fig:unnamed-chunk-19)RStudio Desktop. Новий проект](images/chapter1/rstudio_8.png) 
...
![(\#fig:unnamed-chunk-23)RStudio Desktop. Перегляд змінних](images/chapter1/rstudio_10.png) 
...
![(\#fig:unnamed-chunk-24)Anaconda. Головне вікно](images/chapter1/anaconda_2.png) 

У вікні, що відкрилося потрібно відмітити [x] вставновлення інструментів для роботи з `R`:

![(\#fig:unnamed-chunk-25)Anaconda. Створення нового середовища на основі R](images/chapter1/anaconda_3.png) 

Після встановлення R-інструментів оптрібно переключитися на вкладку `Home` та робочий простір:

![(\#fig:unnamed-chunk-26)Anaconda. Зміна середовища](images/chapter1/anaconda_4.png) 
...
![(\#fig:unnamed-chunk-27)Jupyter Notebook. Створення нового ноутбука](images/chapter1/anaconda_6.png) 
...
![(\#fig:unnamed-chunk-28)Visual Studio Code. Інсталяція RTools](images/chapter1/vs_code.png) 
...
![(\#fig:unnamed-chunk-29)Google Collab](images/chapter1/google_collab.png) 
...
![(\#fig:unnamed-chunk-30)Kaggle.com](images/chapter1/kaggle.png) 
...
![(\#fig:unnamed-chunk-31)RStudio Desktop. Меню інсталяції пакетів](images/chapter1/packages_1.png) 
...
![(\#fig:unnamed-chunk-32)RStudio Desktop. Вибір пакету для інсталяції](images/chapter1/packages_2.png) 
...
![(\#fig:unnamed-chunk-33)RStudio Desktop. Перегляд інстальованих пакетів](images/chapter1/packages_3.png) 
...
![(\#fig:unnamed-chunk-34)RStudio Desktop. Приклад використання пакету `fun`](images/chapter1/packages_4.png) 
